...
(function() {
  var Card, Flush, FourOfAKind, FullHouse, Hand, HighCard, OnePair, Straight, StraightFlush, ThreeOfAKind, TwoPair, startingCards,
  ...
  exports.play = function(game) {
    var call, card, hand, _i, _len, _ref;
    if (game.state === 'complete') {
      return false;
    } else if (game.state === 'pre-flop') {
      call = false;
      _ref = game.self.cards;
